...
import com.donghua.srb.core.mapper.LendItemMapper;
...
public class LendItemServiceImpl extends ServiceImpl<LendItemMapper, LendItem> implements LendItemService {
    ...
    public void notify(Map<String, Object> paramMap) {
        /*
        1.幂等性返回
        2.修改账户金额，余额减少，冻结余额增加
        3.修改lend_item投资记录状态
        4.修改lend_item中的投资人数和已投资金额
        5.新增交易流水
         */
        ...
        // 2.修改账户金额，余额减少，冻结余额增加
        String bindCode = (String)paramMap.get("voteBindCode"); // 投资人绑定号
        String voteAmt = (String) paramMap.get("voteAmt"); // 投资金额
        userAccountMapper.updateAccount(bindCode, new BigDecimal(voteAmt).negate(), new BigDecimal(voteAmt));
